...
class ChallengesControllerTest < ActionController::TestCase
  ...
  test "should create challenge" do
    assert_difference('Challenge.count') do
      post :create, challenge: { description: @challenge.description, name: @challenge.name }
    end
  ...
  test "should update challenge" do
    put :update, id: @challenge, challenge: { description: @challenge.description, name: @challenge.name }
    assert_redirected_to challenge_path(assigns(:challenge))
  end
